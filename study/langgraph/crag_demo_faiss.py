...
# 3.3 初始化 FAISS 向量数据库
# 方式1：从本地加载已有的 FAISS 索引
# 如果你已经有保存的 FAISS 索引，可以这样加载：
try:
    ...
    print(f"⚠️ 无法加载本地索引: {e}")
    print("💡 提示：你可以使用以下代码创建新的 FAISS 索引：")
    print(
        """
    # 创建示例文档
    documents = [
        Document(page_content="LLMOps 是大语言模型运维的缩写..."),
