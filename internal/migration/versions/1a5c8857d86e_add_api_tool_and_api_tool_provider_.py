"""add api_tool and api_tool_provider tables

Revision ID: 1a5c8857d86e
Revises: 42a3ea69088b
Create Date: 2026-05-27 15:47:41.049829
...
revision = '1a5c8857d86e'
down_revision = '42a3ea69088b'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('description', sa.Text(), server_default=sa.text("''::text"), nullable=False),
    sa.Column('openapi_schema', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), nullable=False),
