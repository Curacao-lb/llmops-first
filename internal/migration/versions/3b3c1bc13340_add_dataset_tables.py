...
Revision ID: 3b3c1bc13340
Revises: 6c68b19d640a
Create Date: 2026-06-30 15:41:12.423371
...
revision = "3b3c1bc13340"
down_revision = "6c68b19d640a"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table("dataset", schema=None) as batch_op:
        batch_op.create_index(
            "dataset_account_id_name_idx", ["account_id", "name"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column("dataset_id", sa.UUID(), nullable=False),
        sa.Column(
            "query", sa.Text(), server_default=sa.text("''::text"), nullable=False
        ),
        sa.Column(
            "source",
            sa.String(length=255),
    ...
    with op.batch_alter_table("dataset_query", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "dataset_source_app_id_idx", ["source_app_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "error", sa.Text(), server_default=sa.text("''::text"), nullable=False
        ),
        sa.Column(
    ...
    with op.batch_alter_table("keyword_table", schema=None) as batch_op:
        batch_op.create_index(
            "keyword_table_dataset_id_idx", ["dataset_id"], unique=False
        )
    ...
    with op.batch_alter_table("process_rule", schema=None) as batch_op:
        batch_op.create_index(
            "process_rule_account_id_idx", ["account_id"], unique=False
        )
        batch_op.create_index(
            "process_rule_dataset_id_idx", ["dataset_id"], unique=False
        )
    ...
    with op.batch_alter_table("upload_file", schema=None) as batch_op:
        batch_op.create_index(
            "upload_file_account_id_idx", ["account_id"], unique=False
        )
